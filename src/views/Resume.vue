<template>
    <section id="section">
        ...
        <div class="container">
            ...
            <div class="row p-2" id="education">
                ...
                <div class="col-6 col-md-7">
                    <p>
                        I attended a six Month Full Stack Web Development Bootcamp at Life Choices Coding Academy where I
                        learned how to create Fullstack Websites and Web apps that were are both fully dunctional and mobile
                        responsivee
                    </p>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row p-2" id="education">
                ...
                <div class="col-6 col-md-7">
                    <p>
                        I am currently an Intern at LC Studio where I am upskilling myself as well as preparing myself for a
                        job in a professional workforce
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="col">
                    ...
                    <div class="row">
                        <div class="col text-start">
                            ...
                            <div class="row">
                                <div class="col">
                                    <h6 class="p-1">SCSS</h6>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-striped rounded-pill" role="progressbar"
                                            style="width: 32%" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100">
                                            <span>32%</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-striped rounded-pill" role="progressbar"
                                            style="width: 25%" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100">
                                            <span>25%</span>
                                        </div>
                                    </div>
                                </div>
